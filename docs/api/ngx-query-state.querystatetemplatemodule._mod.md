...
[Home](./index.md) &gt; [ngx-query-state](./ngx-query-state.md) &gt; [QueryStateTemplateModule](./ngx-query-state.querystatetemplatemodule.md) &gt; [ɵmod](./ngx-query-state.querystatetemplatemodule._mod.md)
