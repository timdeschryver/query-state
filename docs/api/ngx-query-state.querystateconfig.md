...
|  [disableInitialLoad?](./ngx-query-state.querystateconfig.disableinitialload.md) | boolean | <i>(Optional)</i> By default, we're fetching the data on the initial load To prevent this, set this to <code>true</code> |
