...
[Home](./index.md) &gt; [query-state-template](./query-state-template.md) &gt; [QueryStateTemplateModule](./query-state-template.querystatetemplatemodule.md) &gt; [ɵmod](./query-state-template.querystatetemplatemodule._mod.md)
